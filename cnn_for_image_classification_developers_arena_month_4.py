# -*- coding: utf-8 -*-
"""CNN  for image classification developers arena month 4.ipynb
...
model_path = "cnn_fashion_model.pth"
...
print("True Label:", labs[sample_label.item()])
print("Predicted Label:", labs[pred_class.item()])